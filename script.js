...
`;
    ...
    modal.id = 'view-modal';
    modal.className = 'fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4 overflow-y-auto';
    modal.innerHTML = `<div class="my-8">${detailsHtml}</div>`;
